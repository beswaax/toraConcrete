...
const Job = () => {
  const job = {
    ...
    secondTextBlockText:
      "To strengthen our team in Toronto, we are looking for a full-time senior architect for our architecture and design department. Flexibility, mutual trust and the ability to work in a team are important to us.",
