...
const EngineerJob = () => {
  const job = {
    ...
    secondTextBlockText:
      "To strengthen our team in Toronto, we are looking for a full-time senior mechanical engineer for our mechanical engineering department. Flexibility, mutual trust and the ability to work in a team are important to us.",
    thirdTextBlockTitle: "Why to apply",
    thirdTextBlockText:
      "We offer attractive pay, a secure job with good work-life balance, flexible working hours with the option to work remotely 2 days a week and much more",
  };
  return (
    <>
